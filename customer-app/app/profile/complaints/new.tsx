...
export default function NewComplaint() {
  ...
  const [orderId, setOrderId] = useState(params.orderId ?? orders[0].id);
  ...
  if (submitted) {
    return (
      <View style={styles.successWrap}>
        ...
        <Button label="View My Complaints" style={{ marginTop: spacing.lg, width: '100%' }} onPress={() => router.replace('/profile/complaints')} />
      </View>
    );
  }
