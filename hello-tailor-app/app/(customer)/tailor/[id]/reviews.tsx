...
export default function TailorReviews() {
  ...
  // ponytail: no addReview action on the shared store — new reviews live only in local state
  // for this screen session, same simplification the old app already used.
    ...
    setReviews((prev) => [
      {
        ...
        avatar: ME_CUSTOMER.avatar,
        rating: newRating,
        date: 'Just now',
        text: newText || 'Great experience!',
        verified: true,
