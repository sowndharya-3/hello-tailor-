...
import { categories, tailors, offers, orders, orderStages } from '../../mocks/data';
    ...
    <View style={styles.wrap}>
      <View style={styles.header}>
        ...
        <Pressable style={styles.locationBtn} onPress={() => {}}>
          ...
          <Text style={styles.locationText} numberOfLines={1}>Anna Nagar, Chennai</Text>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 32 }}>
        ...
        {activeOrder ? (
          <Card style={{ marginHorizontal: spacing.screenH, marginTop: spacing.lg }} onPress={() => router.push(`/order/${activeOrder.id}`)}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
              <View>
                <Text style={styles.trackLabel}>Track Your Order</Text>
                <Text style={styles.trackId}>{activeOrder.id}</Text>
              </View>
              <Badge label={orderStages[activeOrder.currentStageIndex]} tone="info" />
            </View>
        ...
        <Section title="Nearby Tailors" actionLabel="See All" onAction={() => router.push('/(tabs)/tailors')}>
          <FlatList
            data={nearby}
            horizontal
            showsHorizontalScrollIndicator={false}
        ...
        <Section title="Top Rated" actionLabel="See All" onAction={() => router.push('/(tabs)/tailors')}>
          <FlatList
            data={topRated}
            horizontal
            showsHorizontalScrollIndicator={false}
        ...
        <Section title="Featured Tailors" actionLabel="See All" onAction={() => router.push('/(tabs)/tailors')}>
          <FlatList
            data={featured}
            horizontal
            showsHorizontalScrollIndicator={false}
        ...
        <Section title="Offers For You" actionLabel="See All" onAction={() => router.push('/profile/offers')}>
          <FlatList
            data={offers}
            horizontal
            showsHorizontalScrollIndicator={false}
        ...
        <Pressable style={styles.membershipBanner} onPress={() => router.push('/profile/membership')}>
