...
import { tailors, reviews } from '../../../mocks/data';
  ...
  return (
    <View style={styles.wrap}>
        ...
        <View style={styles.headerBlock}>
          ...
          <View style={styles.infoGrid}>
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoText}>{tailor.distanceKm} km • {tailor.locality}</Text>
            </View>
            <View style={styles.infoItem}>
      ...
      <View style={styles.stickyBar}>
        ...
        <Button label="Book Now" style={{ flex: 1, marginLeft: 16 }} onPress={() => router.push(`/booking/${tailor.id}/category`)} />
      </View>
