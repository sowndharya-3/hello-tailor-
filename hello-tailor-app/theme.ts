// Hello Tailor — unified design system tokens (merged from customer-app/tailor-app).
// Both apps used near-identical tokens under different key names; this file exposes
// BOTH naming schemes as aliases so ported screens need minimal edits.
export const colors = {
...
export const type = {
  ...
  amount: { fontFamily: font.familyBold, fontSize: 24 },
};
...
// tailor-app used `radii` — alias it
