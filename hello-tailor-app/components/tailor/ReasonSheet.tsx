// Generic "pick a reason + optional note, then confirm" bottom sheet. Used for both booking
// rejection and order cancellation (ported from tailor-app/components/ReasonSheet.tsx +
// RejectSheet.tsx, merged into one generic component since RejectSheet was a thin wrapper).
