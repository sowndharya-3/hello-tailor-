...
export default function Featured() {
  ...
  const buyFeatured = useStore((s) => s.buyFeatured);
  ...
  return (
    <View style={styles.container}>
      <ScreenHeader title="Featured Listing" onBack={() => router.back()} />
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        {profile.featuredActive && (
          <Card style={styles.activeCard}>
            ...
            <Text style={styles.activeExpiry}>Until {profile.featuredExpiry ? new Date(profile.featuredExpiry).toLocaleDateString('en-IN') : '—'}</Text>
          </Card>
        )}
        ...
        <Card>
          ...
          <Button
            ...
            onPress={() => Alert.alert('Confirm Payment', `Activate Featured listing for ${selected.days} days at ₹${selected.price}?`, [
              ...
              { text: 'Pay Now', onPress: () => { buyFeatured(selected.days); setPurchased(true); } },
            ])}
